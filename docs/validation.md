...
| Preview budgets | `make plan` and `make plan-smoke` with the same config | Sweep and smoke commands have different, explicit request budgets; neither executes AIPerf |
